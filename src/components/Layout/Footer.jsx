...
const FacebookIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor" style={{ marginRight: '10px' }}>
    ...
    <footer>
      <div className="footer-container">
        <div className="footer-logo">
          ...
          <p>Tu aliado en la construcción. Calidad, confianza y servicio de excelencia en Coatzacoalcos, Ver.</p>
        </div>
        ...
        <div className="footer-links">
          ...
          <ul>
            ...
            <li><Link to="/informacion">Información de Contacto</Link></li>
          </ul>
        </div>
      ...
      <div className="footer-bottom" id="footer-bottom-text">
        <span>© {currentYear} Materiales SADA. Todos los derechos reservados.</span>
      </div>
    </footer>
  );
}
